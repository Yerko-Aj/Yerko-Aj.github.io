...
### Objetivo
Nuestro objetivo será obtener información del articulo. <br>([Referencia 15 de la sección SVM de scikit-learn](https://scikit-learn.org/stable/modules/svm.html#mathematical-formulation)). <br>
